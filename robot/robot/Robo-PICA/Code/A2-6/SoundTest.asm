...
;  Date/Time: 4/6/2008 14:12:03
;  Info: http://www.mikroe.com


; ADDRESS	OPCODE	ASM
; ----------------------------------------------
$0000	$2AE2			GOTO	_main
$0004	$	_SDIV3232L:
...
$0308	$09FB			COMF	STACK_11, F
$0309	$09FA			COMF	STACK_10, F
$030A	$09F9			COMF	STACK_9, F
$030B	$09F8			COMF	STACK_8, F
$030C	$0AF8			INCF	STACK_8, F
$030D	$1903			BTFSC	STATUS, Z
$030E	$0AF9			INCF	STACK_9, F
$030F	$1903			BTFSC	STATUS, Z
$0310	$0AFA			INCF	STACK_10, F
$0311	$1903			BTFSC	STATUS, Z
$0312	$0AFB			INCF	STACK_11, F
$0313	$0008			RETURN
$0314	$	_Get_Fosc_kHz:
...
$0318	$304E			MOVLW	78
$0319	$00F1			MOVWF	STACK_0+1
$031A	$01F2			CLRF	STACK_0+2
$031B	$01F3			CLRF	STACK_0+3
;delays.c,5 :: 		}
$031C	$0008			RETURN
$02F5	$	_Delay_Cyc:
...
$02F7	$03B2			DECF	FARG_Delay_Cyc+0, 1
;delays.c,56 :: 		--cycles_div_by_10;
$02F8	$03B2			DECF	FARG_Delay_Cyc+0, 1
;delays.c,57 :: 		while (cycles_div_by_10 > 0) {
$02F9	$	L_Delay_Cyc_0:
$02F9	$0832			MOVF	FARG_Delay_Cyc+0, 0
$02FA	$3C00			SUBLW	0
$02FB	$1803			BTFSC	STATUS, C
$02FC	$2B02			GOTO	L_Delay_Cyc_1
;delays.c,58 :: 		--cycles_div_by_10;
$02FD	$03B2			DECF	FARG_Delay_Cyc+0, 1
;delays.c,59 :: 		asm nop;
$02FE	$0000			NOP
;delays.c,60 :: 		asm nop;
$02FF	$0000			NOP
...
$0274	$3022			MOVLW	34
$0275	$00FC			MOVWF	STACK_12
$0276	$01F8			CLRF	STACK_8
$0277	$01F9			CLRF	STACK_9
$0278	$01FA			CLRF	STACK_10
$0279	$01FB			CLRF	STACK_11
$027A	$	_NEXT:
$027A	$03FC			DECF	STACK_12, F
$027B	$1903			BTFSC	STATUS, Z
$027C	$2AA8			GOTO	_EXIT2
$027D	$1003			BCF	STATUS, C
$027E	$	_LOOP:
$027E	$0CFB			RRF	STACK_11, F
$027F	$0CFA			RRF	STACK_10, F
$0280	$0CF9			RRF	STACK_9, F
$0281	$0CF8			RRF	STACK_8, F
$0282	$0CF3			RRF	STACK_3, F
$0283	$0CF2			RRF	STACK_2, F
$0284	$0CF1			RRF	STACK_1, F
$0285	$0CF0			RRF	STACK_0, F
$0286	$1C03			BTFSS	STATUS, C
$0287	$2A7A			GOTO	_NEXT
$0288	$03FC			DECF	STACK_12, F
$0289	$1903			BTFSC	STATUS, Z
$028A	$2A9A			GOTO	_EXIT1
$028B	$0874			MOVF	STACK_4, W
$028C	$07F8			ADDWF	STACK_8, F
$028D	$0875			MOVF	STACK_5, W
$028E	$1803			BTFSC	STATUS, C
$028F	$0F75			INCFSZ	STACK_5, W
$0290	$07F9			ADDWF	STACK_9, F
$0291	$0876			MOVF	STACK_6, W
$0292	$1803			BTFSC	STATUS, C
$0293	$0F76			INCFSZ	STACK_6, W
$0294	$07FA			ADDWF	STACK_10, F
$0295	$0877			MOVF	STACK_7, W
$0296	$1803			BTFSC	STATUS, C
$0297	$0F77			INCFSZ	STACK_7, W
$0298	$07FB			ADDWF	STACK_11, F
$0299	$2A7E			GOTO	_LOOP
$029A	$	_EXIT1:
$029A	$0874			MOVF	STACK_4, W
$029B	$07F8			ADDWF	STACK_8, F
$029C	$0875			MOVF	STACK_5, W
$029D	$1803			BTFSC	STATUS, C
$029E	$0F75			INCFSZ	STACK_5, W
$029F	$07F9			ADDWF	STACK_9, F
$02A0	$0876			MOVF	STACK_6, W
$02A1	$1803			BTFSC	STATUS, C
$02A2	$0F76			INCFSZ	STACK_6, W
$02A3	$07FA			ADDWF	STACK_10, F
$02A4	$0877			MOVF	STACK_7, W
$02A5	$1803			BTFSC	STATUS, C
$02A6	$0F77			INCFSZ	STACK_7, W
$02A7	$07FB			ADDWF	STACK_11, F
$02A8	$	_EXIT2:
$02A8	$0008			RETURN
$01D8	$	_Div_32x32_S:
...
$02AD	$3010			MOVLW	16
$02AE	$00FC			MOVWF	STACK_12
$02AF	$0D71			RLF	STACK_1, W
$02B0	$0DF8			RLF	STACK_8, F
$02B1	$0DF9			RLF	STACK_9, F
$02B2	$0874			MOVF	STACK_4, W
$02B3	$02F8			SUBWF	STACK_8, F
$02B4	$0875			MOVF	STACK_5, W
$02B5	$1C03			BTFSS	STATUS, C
$02B6	$0F75			INCFSZ	STACK_5, W
$02B7	$02F9			SUBWF	STACK_9, F
$02B8	$1803			BTFSC	STATUS, C
$02B9	$2AC1			GOTO	$+8
$02BA	$0874			MOVF	STACK_4, W
$02BB	$07F8			ADDWF	STACK_8, F
$02BC	$0875			MOVF	STACK_5, W
$02BD	$1803			BTFSC	STATUS, C
$02BE	$0F75			INCFSZ	STACK_5, W
$02BF	$07F9			ADDWF	STACK_9, F
$02C0	$1003			BCF	STATUS, C
$02C1	$0DF0			RLF	STACK_0, F
$02C2	$0DF1			RLF	STACK_1, F
$02C3	$0BFC			DECFSZ	STACK_12, F
$02C4	$2AAF			GOTO	$-21
$02C5	$0008			RETURN
$02C6	$	_Sound_Init:
$02C6	$1303			BCF	STATUS, RP1
$02C7	$1283			BCF	STATUS, RP0
$02C8	$0824			MOVF	FARG_Sound_Init+0, 0
$02C9	$00A1			MOVWF	Sound_soundPortAddr
$02CA	$0825			MOVF	FARG_Sound_Init+1, 0
$02CB	$00F1			MOVWF	STACK_1
$02CC	$3001			MOVLW	1
$02CD	$00F0			MOVWF	STACK_0
$02CE	$0871			MOVF	STACK_1, 0
$02CF	$	L_Sound_Init_3:
$02CF	$1903			BTFSC	STATUS, Z
$02D0	$2AD5			GOTO	L_Sound_Init_4
$02D1	$0DF0			RLF	STACK_0, 1
$02D2	$1070			BCF	STACK_0, 0
$02D3	$3FFF			ADDLW	255
$02D4	$2ACF			GOTO	L_Sound_Init_3
$02D5	$	L_Sound_Init_4:
$02D5	$0870			MOVF	STACK_0, 0
$02D6	$00A2			MOVWF	Sound_pinMask1
$02D7	$09F0			COMF	STACK_0, F
$02D8	$0870			MOVF	STACK_0, 0
$02D9	$00A3			MOVWF	Sound_pinMask0
$02DA	$0824			MOVF	FARG_Sound_Init+0, 0
$02DB	$0084			MOVWF	FSR
$02DC	$0870			MOVF	STACK_0, 0
$02DD	$0580			ANDWF	INDF, 1
$02DE	$1784			BSF	FSR, 7
$02DF	$0870			MOVF	STACK_0, 0
$02E0	$0580			ANDWF	INDF, 1
$02E1	$0008			RETURN
$0132	$	_Sound_Play:
$0132	$2314			CALL	_Get_Fosc_kHz
$0133	$30E8			MOVLW	232
...
$0139	$2272			CALL	_mul_32x32_u
$013A	$0870			MOVF	STACK_0, 0
$013B	$00AA			MOVWF	Sound_Play_per_nc_L0
$013C	$0871			MOVF	STACK_0+1, 0
$013D	$00AB			MOVWF	Sound_Play_per_nc_L0+1
$013E	$0872			MOVF	STACK_0+2, 0
$013F	$00AC			MOVWF	Sound_Play_per_nc_L0+2
$0140	$0873			MOVF	STACK_0+3, 0
$0141	$00AD			MOVWF	Sound_Play_per_nc_L0+3
$0142	$0824			MOVF	FARG_Sound_Play+0, 0
$0143	$00F4			MOVWF	STACK_4
$0144	$0825			MOVF	FARG_Sound_Play+1, 0
...
$014A	$00AA			MOVWF	Sound_Play_per_nc_L0
$014B	$0871			MOVF	STACK_0+1, 0
$014C	$00AB			MOVWF	Sound_Play_per_nc_L0+1
$014D	$0872			MOVF	STACK_0+2, 0
$014E	$00AC			MOVWF	Sound_Play_per_nc_L0+2
$014F	$0873			MOVF	STACK_0+3, 0
$0150	$00AD			MOVWF	Sound_Play_per_nc_L0+3
$0151	$3003			MOVLW	3
...
$015E	$00A8			MOVWF	Sound_Play_nc_L0
$015F	$0871			MOVF	STACK_0+1, 0
$0160	$00A9			MOVWF	Sound_Play_nc_L0+1
$0161	$2314			CALL	_Get_Fosc_kHz
$0162	$0826			MOVF	FARG_Sound_Play+2, 0
$0163	$00F4			MOVWF	STACK_4
$0164	$0827			MOVF	FARG_Sound_Play+3, 0
$0165	$00F5			MOVWF	STACK_4+1
$0166	$01F6			CLRF	STACK_4+2
$0167	$01F7			CLRF	STACK_4+3
$0168	$2272			CALL	_mul_32x32_u
$0169	$0870			MOVF	STACK_0, 0
$016A	$00AE			MOVWF	FLOC_Sound_Play+6
$016B	$0871			MOVF	STACK_0+1, 0
$016C	$00AF			MOVWF	FLOC_Sound_Play+7
$016D	$0872			MOVF	STACK_0+2, 0
$016E	$00B0			MOVWF	FLOC_Sound_Play+8
$016F	$0873			MOVF	STACK_0+3, 0
$0170	$00B1			MOVWF	FLOC_Sound_Play+9
$0171	$0828			MOVF	Sound_Play_nc_L0, 0
$0172	$00F0			MOVWF	STACK_0
$0173	$0829			MOVF	Sound_Play_nc_L0+1, 0
...
$018B	$082E			MOVF	FLOC_Sound_Play+6, 0
$018C	$00F0			MOVWF	STACK_0
$018D	$082F			MOVF	FLOC_Sound_Play+7, 0
$018E	$00F1			MOVWF	STACK_0+1
$018F	$0830			MOVF	FLOC_Sound_Play+8, 0
$0190	$00F2			MOVWF	STACK_0+2
$0191	$0831			MOVF	FLOC_Sound_Play+9, 0
$0192	$00F3			MOVWF	STACK_0+3
$0193	$21D8			CALL	_div_32x32_s
$0194	$0870			MOVF	STACK_0, 0
$0195	$00AA			MOVWF	Sound_Play_per_nc_L0
$0196	$0871			MOVF	STACK_0+1, 0
$0197	$00AB			MOVWF	Sound_Play_per_nc_L0+1
$0198	$0872			MOVF	STACK_0+2, 0
$0199	$00AC			MOVWF	Sound_Play_per_nc_L0+2
$019A	$0873			MOVF	STACK_0+3, 0
$019B	$00AD			MOVWF	Sound_Play_per_nc_L0+3
$019C	$300A			MOVLW	10
$019D	$00F4			MOVWF	STACK_4
$019E	$3000			MOVLW	0
$019F	$00F5			MOVWF	STACK_4+1
$01A0	$0828			MOVF	Sound_Play_nc_L0, 0
$01A1	$00F0			MOVWF	STACK_0
$01A2	$0829			MOVF	Sound_Play_nc_L0+1, 0
$01A3	$00F1			MOVWF	STACK_0+1
$01A4	$22A9			CALL	_div_16x16_u
$01A5	$0870			MOVF	STACK_0, 0
$01A6	$00A8			MOVWF	Sound_Play_nc_L0
$01A7	$0871			MOVF	STACK_0+1, 0
$01A8	$00A9			MOVWF	Sound_Play_nc_L0+1
$01A9	$3000			MOVLW	0
...
$01B3	$0084			MOVWF	FSR
$01B4	$	L_Sound_Play_1:
$01B4	$082A			MOVF	Sound_Play_per_nc_L0, 0
$01B5	$00F0			MOVWF	STACK_0
$01B6	$082B			MOVF	Sound_Play_per_nc_L0+1, 0
$01B7	$00F1			MOVWF	STACK_0+1
$01B8	$082C			MOVF	Sound_Play_per_nc_L0+2, 0
$01B9	$00F2			MOVWF	STACK_0+2
$01BA	$082D			MOVF	Sound_Play_per_nc_L0+3, 0
$01BB	$00F3			MOVWF	STACK_0+3
$01BC	$3001			MOVLW	1
$01BD	$02AA			SUBWF	Sound_Play_per_nc_L0, 1
$01BE	$1C03			BTFSS	STATUS, C
$01BF	$02AB			SUBWF	Sound_Play_per_nc_L0+1, 1
$01C0	$1C03			BTFSS	STATUS, C
$01C1	$02AC			SUBWF	Sound_Play_per_nc_L0+2, 1
$01C2	$1C03			BTFSS	STATUS, C
$01C3	$02AD			SUBWF	Sound_Play_per_nc_L0+3, 1
...
$01CC	$0828			MOVF	Sound_Play_nc_L0, 0
$01CD	$00B2			MOVWF	FARG_Delay_Cyc+0
$01CE	$22F5			CALL	_Delay_Cyc
$01CF	$0823			MOVF	Sound_pinMask0, 0
$01D0	$0580			ANDWF	INDF, 1
$01D1	$0828			MOVF	Sound_Play_nc_L0, 0
$01D2	$00B2			MOVWF	FARG_Delay_Cyc+0
$01D3	$22F5			CALL	_Delay_Cyc
...
$01D7	$0008			RETURN
$02E2	$	_main:
;SoundTest.c,1 :: 		void main()
;SoundTest.c,3 :: 		Sound_Init(&PORTC, 0);           // Init Sound
$02E2	$3007			MOVLW	PORTC
$02E3	$1303			BCF	STATUS, RP1
$02E4	$1283			BCF	STATUS, RP0
$02E5	$00A4			MOVWF	FARG_Sound_Init+0
$02E6	$01A5			CLRF	FARG_Sound_Init+1, 1
$02E7	$22C6			CALL	_Sound_Init
;SoundTest.c,4 :: 		while(1)
$02E8	$	L_main_0:
;SoundTest.c,6 :: 		if (!PORTA.F4)              // Test RA4 keypress
$02E8	$1A05			BTFSC	PORTA, 4
$02E9	$2AF3			GOTO	L_main_2
;SoundTest.c,7 :: 		sound_play(2000,100);       // 2 kHz sound ON RC0 at 100 ms
$02EA	$30D0			MOVLW	208
$02EB	$00A4			MOVWF	FARG_Sound_Play+0
$02EC	$3007			MOVLW	7
$02ED	$00A5			MOVWF	FARG_Sound_Play+1
$02EE	$3064			MOVLW	100
$02EF	$00A6			MOVWF	FARG_Sound_Play+2
$02F0	$3000			MOVLW	0
$02F1	$00A7			MOVWF	FARG_Sound_Play+3
$02F2	$2132			CALL	_Sound_Play
$02F3	$	L_main_2:
;SoundTest.c,8 :: 		}
$02F3	$2AE8			GOTO	L_main_0
;SoundTest.c,9 :: 		}
$02F4	$2AF4			GOTO	$
